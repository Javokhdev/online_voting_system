...
func Load() Config {
	...
	config.HTTPPort = cast.ToString(coalesce("HTTP_PORT", ":7070"))
	config.TCP_PORT = cast.ToString(coalesce("TCP_PORT", ":50050"))
	...
	config.DB_NAME = cast.ToString(coalesce("DB_NAME", "public"))
