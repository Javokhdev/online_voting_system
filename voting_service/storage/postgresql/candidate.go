...
func (s *CandidateStorage) CreateCandidate(candidate *v.CreateCandidateReq) (*v.Void, error) {
	id := uuid.New().String()
...
func (s *CandidateStorage) GetCandidateById(id *v.ById) (*v.GetCandidateRes, error) {
...
func (s *CandidateStorage) GetAllCandidates(flt *v.Filter) (*v.GetAllCandidateRes, error) {
...
func (s *CandidateStorage) UpdateCandidate(candidate *v.GetCandidateRes) (*v.Void, error) {
...
func (s *CandidateStorage) DeleteCandidate(id *v.ById) (*v.Void, error) {
