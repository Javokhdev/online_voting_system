...
func (c *electionServiceClient) Create(ctx context.Context, in *CreateElectionReq, opts ...grpc.CallOption) (*Void, error) {
	out := new(Void)
	err := c.cc.Invoke(ctx, "/election.ElectionService/Create", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *electionServiceClient) GetById(ctx context.Context, in *ById, opts ...grpc.CallOption) (*GetElectionRes, error) {
	...
	err := c.cc.Invoke(ctx, "/election.ElectionService/GetById", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *electionServiceClient) GetAll(ctx context.Context, in *Filter, opts ...grpc.CallOption) (*GetAllElectionRes, error) {
	...
	err := c.cc.Invoke(ctx, "/election.ElectionService/GetAll", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *electionServiceClient) Update(ctx context.Context, in *GetElectionRes, opts ...grpc.CallOption) (*Void, error) {
	out := new(Void)
	err := c.cc.Invoke(ctx, "/election.ElectionService/Update", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *electionServiceClient) Delete(ctx context.Context, in *ById, opts ...grpc.CallOption) (*Void, error) {
	out := new(Void)
	err := c.cc.Invoke(ctx, "/election.ElectionService/Delete", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ElectionService_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/election.ElectionService/Create",
	}
...
func _ElectionService_GetById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/election.ElectionService/GetById",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ElectionService_GetAll_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/election.ElectionService/GetAll",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ElectionService_Update_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/election.ElectionService/Update",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ElectionService_Delete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/election.ElectionService/Delete",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
