...
const (
	CandidateService_Create_FullMethodName  = "/voting.CandidateService/Create"
	CandidateService_GetById_FullMethodName = "/voting.CandidateService/GetById"
	CandidateService_GetAll_FullMethodName  = "/voting.CandidateService/GetAll"
	CandidateService_Update_FullMethodName  = "/voting.CandidateService/Update"
	CandidateService_Delete_FullMethodName  = "/voting.CandidateService/Delete"
)
...
func (c *candidateServiceClient) GetById(ctx context.Context, in *ById, opts ...grpc.CallOption) (*GetCandidateRes, error) {
	...
	err := c.cc.Invoke(ctx, CandidateService_GetById_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *candidateServiceClient) Update(ctx context.Context, in *GetCandidateRes, opts ...grpc.CallOption) (*Void, error) {
	out := new(Void)
	err := c.cc.Invoke(ctx, CandidateService_Update_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
