...
func (c *partyServiceClient) Create(ctx context.Context, in *CreatePartyReq, opts ...grpc.CallOption) (*Void, error) {
	out := new(Void)
	err := c.cc.Invoke(ctx, "/party.PartyService/Create", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *partyServiceClient) GetById(ctx context.Context, in *ById, opts ...grpc.CallOption) (*GetPartyRes, error) {
	out := new(GetPartyRes)
	err := c.cc.Invoke(ctx, "/party.PartyService/GetById", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *partyServiceClient) GetAll(ctx context.Context, in *Filter, opts ...grpc.CallOption) (*GetAllPartyRes, error) {
	...
	err := c.cc.Invoke(ctx, "/party.PartyService/GetAll", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *partyServiceClient) Update(ctx context.Context, in *GetPartyRes, opts ...grpc.CallOption) (*Void, error) {
	out := new(Void)
	err := c.cc.Invoke(ctx, "/party.PartyService/Update", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *partyServiceClient) Delete(ctx context.Context, in *ById, opts ...grpc.CallOption) (*Void, error) {
	out := new(Void)
	err := c.cc.Invoke(ctx, "/party.PartyService/Delete", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _PartyService_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/party.PartyService/Create",
	}
...
func _PartyService_GetById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/party.PartyService/GetById",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _PartyService_GetAll_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/party.PartyService/GetAll",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _PartyService_Update_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/party.PartyService/Update",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _PartyService_Delete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/party.PartyService/Delete",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
